...
{
    public class CompilationParser : CompilationScaner
    {
        ...
        public Dictionary<int, (int, string)> Parser(string[] tokens, int[] codes, int lang)
        {
        ...
        // ИЗМЕНЕНО: protected -> public
        public (string[], int[], int[], int[]) Space_Clean(string[] tokens, int[] codes, int[] lines, int[] pos)
        {
